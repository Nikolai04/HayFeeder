...
static volatile uint8_t ble_cpu2_status;
...
{
  ble_cpu2_status = 0U;
  printf("BLE system init start\r\n");
  System_Init();       /**< System initialization */

  SystemPower_Config(); /**< Configure the system Power Mode */

  HW_TS_Init(hw_ts_InitMode_Full, &hrtc); /**< Initialize the TimerServer */
  printf("BLE waiting for CPU2 ready event\r\n");
...
uint8_t HayFeeder_BleCpu2Status(void)
{
  return ble_cpu2_status;
}
...
static void APPE_SysUserEvtRx(void * pPayload)
{
  ...
  case SHCI_SUB_EVT_CODE_READY:
    ...
    printf("CPU2 ready: wireless %d.%d.%d, FUS %d.%d.%d\r\n",
...
static void APPE_SysEvtReadyProcessing(void * pPayload)
{
  ...
  if (p_sys_ready_event->sysevt_ready_rsp == WIRELESS_FW_RUNNING)
  {
    ...
    */
    ...
    printf("CPU2 wireless firmware running\r\n");
  ...
  else if (p_sys_ready_event->sysevt_ready_rsp == FUS_FW_RUNNING)
  {
    ...
    */
    ...
    printf("CPU2 is in FUS mode, not BLE stack mode\r\n");
  ...
  else
  {
    ...
    printf("CPU2 ready unexpected response: 0x%02x\r\n", p_sys_ready_event->sysevt_ready_rsp);
  }
